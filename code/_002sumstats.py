...
mean_spf_trim = mean_spf_trim['1981-09-30':'2016-12-31']  # Filter data
ind_spf_trim = ind_spf_trim['1981-09-30':'2016-12-31']
...
num_for = np.count_nonzero(ind_spf_trim['ID'].unique())
